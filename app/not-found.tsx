...
export const metadata: Metadata = {
  ...
  description:
    "The page you are looking for might have been removed, had its name changed, or is temporarily unavailable. Go back to the SHOP.CO homepage to explore more.",
  keywords: "404 error, page not found, shop.co, zeenat, error page, website error, return to home",
  robots: "noindex, follow", // Prevent indexing but allow links to be followed.
  openGraph: {
    title: "404 | Page Not Found - SHOP.CO",
    description:
      "This page is not available. Go back to the homepage to explore our amazing collection of products.",
    type: "website",
    siteName: "SHOP.CO",
    ...
    <div className={`${inter.className} bg-white`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 mt-7 md:py-24 lg:py-32">
        <div className="flex flex-col items-center text-center">
          ...
          <Button
            asChild
            className="h-12 px-8 bg-primary hover:bg-primary/80 text-primary-foreground rounded-full text-base"
          >
