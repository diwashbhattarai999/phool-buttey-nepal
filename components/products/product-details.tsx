        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <div className="mt-6 flex items-center gap-4">
              <span className={cn("text-2xl font-bold", satoshi.className)}>${product.price}</span>
              <span className="text-lg text-gray-500 line-through">${product.originalPrice}</span>
              <span className="text-red-500 text-sm font-medium">-{discount}%</span>
            </div>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="flex-1 py-3 bg-primary ring ring-primary/50 text-primary-foreground rounded-full hover:bg-primary/80 transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
