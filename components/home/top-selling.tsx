...
const products: Product[] = [
  {
    id: "5",
    name: "Traditional Malmal Ruffle Bloom Dress",
    price: 180,
    rating: 4.5,
  ...
  {
    id: "6",
    name: "Baby Malmal Cotton Bhoto Suruwal Set (0–12 Months)",
    price: 130,
    originalPrice: 160,
    rating: 4.5,
  ...
  {
    id: "3",
    name: "3 Layer Dhaka Malmal Khasto Sirak",
    price: 120,
    rating: 4.5,
          ...
          >
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <span className={` ${satoshi.className} text-lg font-semibold `}>
                  ${product.price}
                </span>
